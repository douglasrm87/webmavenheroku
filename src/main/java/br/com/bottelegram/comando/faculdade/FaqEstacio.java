...
public class FaqEstacio {
	...
	private static final String ADM_ESTACIO_BR = "\n\nAdministração: lucimara.candiotto@estacio.br";
	...
	private static final String VIDEO_EMAIL_INSTITUCIONAL = "Vídeo e-mail Institucional.";
	...
	private static final String REFORCO_AO_VIVO = "Reforço ao Vivo";
	...
	public List<FAQ> carregarNivelSemanaPesquisa() {
		...
		duvida = new FAQ(SEMANA_PESQUISA_ID, 1, "Super Evento",
				"\n\nI SEMINÁRIO DE EXTENSÃO E PESQUISA DA REGIONAL CENTRO SUL - SEPESQ\n"
						+ "II JORNADA DE INICIAÇÃO CIENTÍFICA DA ESTÁCIO CURITIBA E DA FATEC\n"
						+ "21 e 22 Outubro - quarta  (manhã e noite) e quinta (manhã e noite).\n");
		nivel02.add(duvida);

		duvida = new FAQ(SEMANA_PESQUISA_ID, 2, "Cartaz Evento",
				"\n\nPara receber seu certificado cadastrar-se no site: https://linktr.ee/pesquisa.curitiba, opção: Inscrição de Ouvinte.\n "
						+ "Realizar o logar no site, pode ser via Facebook, Instagram, Linked-IN ou cadastrar uma nova conta. \n"
						+ "Clicar no botão + e em seguida Continuar, preencher os dados e concluir seu cadastro.\n",
				true, "sepesq/Cartaz.jpg");
		nivel02.add(duvida);

		duvida = new FAQ(SEMANA_PESQUISA_ID, 3, "Programação Evento",
		...
		duvida = new FAQ(SEMANA_PESQUISA_ID, 4, "Trabalhos Aprovados",
				"\n10 AACs para alunos que farão apresentações.\n Ao final de cada apresentação será liberado um link para os alunos ouvintes. Ao preencher o aluno receberá 5 AACs.\nConheça todos os trabalhos que serão apresentados em nosso evento.",
				true, "sepesq/listadostrabalhosaprovadoscuritiba.pdf");
		nivel02.add(duvida);

		duvida = new FAQ(SEMANA_PESQUISA_ID, 5, "Dicas do evento",
				"\nConheça as principais dicas de nosso super evento.", true, "sepesq/Carddoseminarioaosalunos.pdf");
		nivel02.add(duvida);

		StringBuilder salas = new StringBuilder();
		salas.append("\nSeguem os Links para as salas da primeira noite (21/Outubro, Quarta-feira):");

		salas.append("\n\nSALA 1 - <b>ESPAÇO DA TECNOLOGIA DA INFORMAÇÃO </b> (4 trabalhos);");
		salas.append("\nencurtador.com.br/nGKV5");

		salas.append("\n\nSALA 2 - <b>ESPAÇO DA SAÚDE E DAS LICENCIATURAS</b> (5 trabalhos);");
		salas.append("\nencurtador.com.br/mopr8");

		salas.append("\n\nSALA 3 - <b>ESPAÇO DAS ENGENHARIAS E DA ECONOMIA CRIATIVA</b> (5 trabalhos);");
		salas.append("\nencurtador.com.br/mnGMQ");

		salas.append("\n\nSALA 4 - <b>ESPAÇO DA GESTÃO</b> (10 trabalhos);");
		salas.append("\nencurtador.com.br/cfAMX");

		salas.append("\n\nSALA 5 - <b>ESPAÇO 1 DAS CIÊNCIAS JURÍDICAS</b> (11 trabalhos);");
		salas.append("\nencurtador.com.br/myJLS");

		salas.append("\n\nSALA 6 - <b>ESPAÇO 2 DAS CIÊNCIAS JURÍDICAS</b> (11 trabalhos).");
	...
	public List<FAQ> carregarNivelAcademico() {
		...
		String tipoAACInterna = "\nInternas: Atividades realizadas pela própria Estácio (Palestras Seminários...).";
		...
		duvida = new FAQ(ACADEMICO_ID, 10, VIDEO_EMAIL_INSTITUCIONAL,
				"\nVídeo sobre como <b>criar o email institucional</b>.", true, "whatsappvideoemailinstitucional.mp4");
		nivel01.add(duvida);
		...
		nivel01.add(duvida);
		String descAvaliandoAprendizado = "\n\nO Avaliando o Aprendizado são simulados distribuídos ao longo do semestre que irão abordar os conteúdos da disciplina, onde o aluno poderá receber até 2,0 pontos extras na AV3.";
		...
		String descReforcoVivo = "\n\nO Reforço ao vivo são aulas ao vivo que irão abordar os conteúdos críticos do ensino médio, divididos por áreas de conhecimento:";
		...
		duvida = new FAQ(ACADEMICO_ID, 20, EDO,
				"\nComo realizar as provas das disciplinas do formato Ensino Dirigido ONLINE\n: OBS.: As notas das disciplinas de EDO serão divulgadas após a sua finalização, ou seja, ao final do semestre.\n"
						+ ELIZABETH_ESTACIO_BR + DEBORA_ESTACIO_BR,
				true, "edo/faqEDO.png");
		nivel01.add(duvida);

		duvida = new FAQ(ACADEMICO_ID, 21, REGULAMENTO_ACC,
				"\nTodas as informações sobre horas de Atividades Acadêmicas Complementares.\n", true,
	...
	public List<FAQ> carregarNivelBoleto() {
		...
		String discCreditos = "\nCada disciplina possui um número fixo de créditos. A modalidade de cobrança esta relacionada aos créditos de cada "
				...
				+ "deseja reduzir ou aumentar os créditos deverá contactar a coordenação de seu curso.";
		...
		mensalidadeAumentou.append("Nossa mensalidade é calculada em cima dos créditos e não na quantidade de disciplinas! \n");  
		mensalidadeAumentou.append("O crédito representa o valor que cada disciplina vai custar, e varia de acordo com o Campus/Curso/Turno de cadastro do aluno.\n"); 
		mensalidadeAumentou.append("Veja o exemplo: Você cursava 6 disciplinas no semestre passado, com um total de 12 créditos.\n"); 
		mensalidadeAumentou.append("Neste semestre, você está matriculado em 5 disciplinas, com um total de 13 créditos.\n"); 
		mensalidadeAumentou.append("Você diminuiu as disciplinas, mas aumentou a quantidade de créditos. \n");
		mensalidadeAumentou.append("Por esse motivo, o valor da mensalidade será maior que no semestre passado.\n"); 
		mensalidadeAumentou.append("<b>Fique atento: você pode visualizar a quantidade de créditos por disciplina na discriminação dos valores no seu boleto!\n"); 
		mensalidadeAumentou.append("Todos os valores pagos acima do valor esperado, serão descontados nos próximos boletos. Fique tranquilo.</b>\n");
	...
	public List<FAQ> carregarNivelGrade() {
		...
		String gradeVazia = "\nCaso receba a mensagem do SIA: Turmas Indisponíveis. Para mais informações, entre em contato com a sua Coordenação ... \n"
				...
				+ "Realizaremos estudo de viabilidade para abertura de turmas EDO (Estudo Dirigido Online) ou EDP (Estudo Dirigido Presencial) apÃ¯Â¿Â½s abertura do requerimento. "
